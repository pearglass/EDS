...
public class LikelihoodEvidenceDialogBuilder implements ILikelihoodEvidenceDialogBuilder {
	...
	private ResourceBundle resource = ResourceController.newInstance().getBundle(
				...
				Locale.getDefault(),
				LikelihoodEvidenceDialogBuilder.class.getClassLoader()
			);
	...
	/*
	 * (non-Javadoc)
	 * @see unbbayes.gui.ILikelihoodEvidenceDialogBuilder#buildDialog(unbbayes.prs.Graph, unbbayes.prs.INode, java.awt.Component)
	 */
	public JDialog buildDialog(Graph graph, final INode nodeToAddLikelihood, final Component owner) {
		...
		// add lister invoked when closing dialog and OK was pressed
...
//		panel.setMaximumSize(new Dimension(100, 100));
	...
	protected JTable buildMainTable(Graph graph, INode nodeToAddLikelihood) {
		// dummy table to display to user
	 ...
	 */
	protected ComponentListener buildLikelihoodEvidenceDialogComponentListener(
			Graph graph, INode nodeToAddLikelihood, JTable table, JOptionPane optPane) {
	...
	public class LikelihoodEvidenceDialogComponentListener implements ComponentListener {
		 ...
		 */
		public LikelihoodEvidenceDialogComponentListener(
				INode nodeToAddLikelihood, JTable table, JOptionPane optPane) {
