...
public interface INetworkMediator {
	 ...
	 */
	public abstract void previewPrintLog(final JTextArea texto,
	 ...
	 */
	public abstract void previewPrintNet(final JComponent rede,
			final Rectangle retangulo);
	 ...
	 */
	public abstract void printNet(final JComponent network,
